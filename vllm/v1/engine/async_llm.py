...
class AsyncLLM(EngineClient):
    ...
    async def add_request(
        ...
        if (
            ...
            # bind internal id to external id
            requestTimeline.bind_id(request.external_req_id, request.request_id)
    ...
    async def get_engine_core_request_timeline_dict(self) -> dict[str, Any]:
        return await self.engine_core.call_utility_async("get_request_timeline_dict")
